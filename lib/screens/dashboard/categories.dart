...
class _CategoriesScreenState extends ConsumerState<CategoriesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final categoriesProviderRef = ref.watch(categoriesNotifierProvider);
    return categoriesProviderRef.when(
      data: (categoriesData) {
        return Scaffold(
          body: SafeArea(
            child: Column(
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [CategoriesList(categoriesData: categoriesData)],
                  ),
                )),
              ],
            ),
